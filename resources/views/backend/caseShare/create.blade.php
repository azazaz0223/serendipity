...
@section('container')
    <nav class="" aria-label="breadcrumb">
        <ol class="breadcrumb d-flex justify-content-start lh-lg m-0 ms-3">
            ...
            <li class="breadcrumb-item col">新增案例</li>
        </ol>
    </nav>
        ...
        <div class="card col-12 rounded-3 bg-white mb-4">
            ...
            <div class="card-body border-bottom">
                <div class="d-flex justify-content-start gap-3 mb-3">
                    ...
                    <div class="col-2">
                        <div class="radio_style wd100">
                            <input type="radio" id="up" name="status" value="1" checked>
                            <label class="wd47" for="up">上架</label>
                            <input type="radio" id="down" name="status" value="0">
                ...
                <div class="d-flex justify-content-start gap-3 mb-3">
                    ...
                    <div class="col">
                        <textarea id="summary" class="form-control search_input easein mb-0" rows="2"></textarea>
                    </div>
                </div>
            </div>

            <div class="card-body border-bottom">
                <textarea id="caseShare_content" class="form-control search_input easein mb-0"></textarea>
            </div>

            <div class="card-body">
                <button type="button" class="btn btn-danger border-0 rounded-3 float-end shadow-sm px-3"
                    onclick="createBtn(2)">暫存</button>
    ...
    <script>
        ...
        function createBtn(status) {
            ...
            data.content = CKEDITOR.instances['caseShare_content'].getData();

            $.ajax({
                url: "{{ route('backend.caseShare.store') }}",
                type: "POST",
                headers: {
